...
clause1(hasCorrespondingAttributePath(refSemantic31,'0173-1#02-AAO663#002'),true).
clause1(type(refSemantic31,refSemantic),true).
clause1(hasAttributeValue(attribute31,'0173-1---BASIC_1_1#01-ABW077#009'),true).
...
clause1(hasCorrespondingAttributePath(refSemantic21,'ECLASS:0173-1#02-BAE122#006'),true).
...
clause1(hasAttributeName(attribute61,'GTIN'),true).
...
clause1(hasAttributeName(attribute51,'Cooling type'),true).
...
clause1(hasAttributeValue(attribute32,'0173-1---BASIC_1_1#01-ABW077#009'),true).
...
clause1(hasAttributeName(attribute42,'Cooling type'),true).
...
clause1(hasCorrespondingAttributePath(refSemantic12,'ECLASS:0173-1#02-BAE122#006'),true).
