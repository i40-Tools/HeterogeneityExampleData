...
clause1(hasAttributeValue(attribute41,'27022501'),true).
...
clause1(identifier(instanceHierarchy21,'acf9f51b'),true).
...
clause1(hasAttributeName(attribute81,'GTIN'),true).
...
clause1(hasAttributeName(attribute71,'Cooling type'),true).
...
clause1(hasAttributeName(attribute61,'Construction form of DC motor'),true).
...
clause1(hasAttribute(internalElement41,attribute21),true).
...
clause1(hasAttributeValue(attribute51,'0173-1---BASIC_1_1#01-ABW077#009'),true).
...
clause1(identifier(instanceHierarchy22,'acf9f51b'),true).
