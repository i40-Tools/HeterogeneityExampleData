...
clause1(hasAttributeValue(attribute31,'1000_4'),true).
...
clause1(hasAttributeValue(attribute11,'L'),true).
...
clause1(hasAttributeValue(attribute21,'LIRCS'),true).
clause1(hasAttributeName(attribute21,'PCEFunction'),true).
...
clause1(hasAttributeName(attribute12,'PCEFunction'),true).
