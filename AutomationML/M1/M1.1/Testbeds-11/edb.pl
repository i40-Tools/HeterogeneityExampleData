...
clause1(hasAttributeValue(attribute11,'1000_4'),true).
...
clause1(hasAttributeValue(attribute12,'1000-4'),true).
clause1(hasAttributeName(attribute12,'FlowchartNumber'),true).
