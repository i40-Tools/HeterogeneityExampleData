...
clause1(hasAttributeValue(attribute12,'35.00'),true).
clause1(hasAttributeName(attribute12,'length'),true).
...
clause1(hasAttributeName(internalElement12,'AMLObject'),true).
