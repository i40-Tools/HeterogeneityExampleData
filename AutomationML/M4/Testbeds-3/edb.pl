...
clause1(hasAttributeValue(attribute11,'5.0 '),true).
clause1(hasAttributeName(attribute11,'mass'),true).
...
clause1(hasAttributeValue(attribute12,'false'),true).
clause1(hasAttributeName(attribute12,'AllowManufacture'),true).
...
clause1(hasCorrespondingAttributePath(refSemantic12,'NE 150 v1.0 Annex 2.2.1'),true).
