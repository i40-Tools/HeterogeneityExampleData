...
clause1(hasAttributeValue(attribute31,'0173-1#01-AKE162#012'),true).
...
clause1(hasCorrespondingAttributePath(refSemantic21,'ECLASS:0173-1#02-BAE072#005'),true).
...
clause1(hasAttributeName(attribute41,'Construction form of DC motor'),true).
clause1(type(attribute41,attribute),true).
clause1(hasAttributeValue(attribute21,'27022501'),true).
clause1(hasAttributeName(attribute21,'eClassClassificationClass'),true).
clause1(type(attribute21,attribute),true).
clause1(hasCorrespondingAttributePath(refSemantic11,'ECLASS:0173-1#02-BAE069#007'),true).
...
clause1(hasAttributeName(attribute51,'Construction size of DC motor'),true).
...
clause1(hasAttributeValue(attribute32,'0173-1#01-AKE162#012'),true).
...
clause1(hasAttributeName(attribute42,'Data cable'),true).
clause1(type(attribute42,attribute),true).
clause1(hasAttributeValue(attribute22,'27022501'),true).
clause1(hasAttributeName(attribute22,'eClassClassificationClass'),true).
clause1(type(attribute22,attribute),true).
clause1(hasCorrespondingAttributePath(refSemantic12,'ECLASS:0173-1#02-AKE197#013'),true).
