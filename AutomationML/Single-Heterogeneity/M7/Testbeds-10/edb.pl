...
clause1(hasAttributeValue(attribute11,'35.0'),true).
clause1(hasAttributeName(attribute11,'maxTransportationWeight'),true).
...
clause1(hasAttributeName(roleClass11,'RollerConveyor'),true).
clause1(type(roleClass11,roleClass),true).
clause1(hasCorrespondingAttributePath(refSemantic11,'ECLASS:0173-1#02-AAI721#002'),true).
...
clause1(hasAttributeName(roleClass12,'RollerConveyor'),true).
